...
def vocab_config(args, wordvocab):
...
def get_args():
    ...
    parser.add_argument('--data_midname', type=str, default='input_source',help='distinguish different task')
    ...
    parser.add_argument('--cls_batch_size', type=int, default=32, help='Mini batch size [default: 8]')
    ...
    parser.add_argument('--docset_max_len', type=int, default=12,help='max number of documents set')
    ...
    parser.add_argument('--min_length', default=110, type=int)
    ...
    parser.add_argument("--no_repeat_ngram_size", default=0, type=int, help='ngram blocking parameter, to avoid repeat')
    ...
    parser.add_argument("--loss_topic", default=0.001, type=float)
    parser.add_argument("-kl_annealing_steps", type=int, default=30000, help="Warm up step")
    parser.add_argument("--m_per_class_sampler", action="store_true", default=True)
    parser.add_argument('--max_cls_length', default=128, type=int)
