...
def get_args():
    ...
    parser.add_argument('--rhe_data_dir', type=str, default='data/CNNDM',help='The dataset directory.')
    ...
    parser.add_argument('--doc_max_timesteps', type=int, default=15,help='max length of documents (max timesteps of documents)')
